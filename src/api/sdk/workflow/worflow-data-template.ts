...
export const worflowDataTemplate = (params: any) =>{
    ...
    if (params.workflowCredentialType){ 
        form.append( 'workflowCredentialType', params.workflowCredentialType || "Default");
    }
    if (params.credentialId){
        form.append( 'credentialId', params.credentialId || "");
    }
    if (params.collectionIds){
        form.append( 'collectionIds', params.credentialId || "[]");
    }
